...
remain the mutation boundary. The monitor baseline is committed only after the
reasoning turn and requested delivery succeed; a delivery failure is retried on
the next unchanged observation instead of being mistaken for a delivered alert.
